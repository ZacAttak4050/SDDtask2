...
class MessageBoard(object):
    ...
    """
    def __init__(self, surface, rect, text, font=('calibri', 20), font_color=Color('white'), bgcolor=Color('gray25'),border_width=0, border_color=Color('black'), tooltip=False, game=None, alpha=255):
